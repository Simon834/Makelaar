                ...
                return (
                  <div key={i}>
                    <ListItem button>
                      <ListItemIcon>
                        <Avatar
                          ...
                          src={
                            e.name === "Makelaar"
                              ? "https://image.shutterstock.com/image-vector/beautiful-pensive-brunette-office-secretary-260nw-243022681.jpg"
                              : "https://thumbs.dreamstime.com/b/default-avatar-profile-icon-vector-social-media-user-portrait-176256935.jpg"
                          }
                        />

                        <span>
                          <ListItemText primary={e.name} align="right">
                            {e.name}-
                          </ListItemText>
                        </span>
                    ...
                    <ListItemText
                      ...
                      align="justify"
                    >
                      <div dangerouslySetInnerHTML={summary(e.mensaje)} />
                    </ListItemText>
                  </div>
                );
              })}
