    ...
    <>
      {!inmuebles.length ? (
        <div>
          ...
          <br />
          <em>
            En este momento no contamos con propiedades con estas
            características
          </em>
          <br />
          <em>
            Lo invitamos a ponerse en contacto con nosotros para mayores
            consultas{" "}
          </em>
          <br />
          <br />
        ...
        <Grid container spacing={6}>
          {inmuebles.map((inm) => {
          let contract
          if(inm.Contracts.length){
            contract=inm.Contracts[inm.Contracts.length - 1]
          }else{
            contract=null
          }
